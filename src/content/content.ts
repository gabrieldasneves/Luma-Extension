...
if ((globalThis as Record<string, unknown>)[LUMA_LOADED_KEY]) {
  ...
  function scheduleSelectionCheck () {
    ...
    selectionTimer = setTimeout(() => { void publishSelection() }, 100)
  }

  document.addEventListener('mouseup', () => { void publishSelection() }, true)
  document.addEventListener('keyup', () => { void publishSelection() }, true)
